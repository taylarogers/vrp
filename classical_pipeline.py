...
if __name__ == "__main__":
    ...
    algorithms = [
        {"script_name": "SA.py", "script_folder": "simulated-annealing"},
        {"script_name": "branch-and-bound.py", "script_folder": "branch-and-bound"}
    ]

    # Output files for each algorithm
    output_files = {
        "SA.py": "output_sa.txt",
        "branch-and-bound.py": "output_bnb.txt"
    }
    ...
    print("Results for SA.py are stored in output_sa.txt")
    print("Results for branch-and-bound.py are stored in output_bnb.txt")
